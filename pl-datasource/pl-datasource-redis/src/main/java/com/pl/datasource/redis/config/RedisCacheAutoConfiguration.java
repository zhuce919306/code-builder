...
import com.pl.datasource.redis.core.DefaultRedisCacheWriter;
import com.pl.datasource.redis.core.RedisAutoCacheManager;
...
public class RedisCacheAutoConfiguration {
    ...
    RedisCacheAutoConfiguration(CacheProperties cacheProperties, CacheManagerCustomizers customizerInvoker, ObjectProvider<RedisCacheConfiguration> redisCacheConfiguration) {
    ...
    public RedisCacheManager cacheManager(RedisConnectionFactory connectionFactory, ResourceLoader resourceLoader) {
        ...
        RedisAutoCacheManager cacheManager = new RedisAutoCacheManager(redisCacheWriter, cacheConfiguration, initialCaches, true);
